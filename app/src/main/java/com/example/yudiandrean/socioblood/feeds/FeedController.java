...
import com.example.yudiandrean.socioblood.volley.LruBitmapCache;

public class FeedController extends Application {
    ...
    public static synchronized FeedController getInstance() {
        return mInstance;
    }
